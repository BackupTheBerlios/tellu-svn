struct cmdArray cmdArrays[] = {
	...
	{ PRIVILEGE_LEVEL_ADMIN, "listLog", NULL, listLog, replyFree },
	{ PRIVILEGE_LEVEL_ADMIN, "pullLog", NULL, pullLog, replyFree },
	{ PRIVILEGE_LEVEL_ADMIN, "searchLog", NULL, searchLog, replyFree },
	{ PRIVILEGE_LEVEL_ADMIN, "listHistory", NULL, listHistory, replyFree },
	{ PRIVILEGE_LEVEL_ADMIN, "pullHistory", NULL, pullHistory, replyFree },
	{ PRIVILEGE_LEVEL_ADMIN, "searchHistory", NULL, searchHistory, replyFree },
	{ PRIVILEGE_LEVEL_ADMIN, "pullDatabaseStatus", NULL, pullDatabaseStatus, replyFree },
	{ PRIVILEGE_LEVEL_ADMIN, "pullDatabaseVariables", NULL, pullDatabaseVariables, replyFree },
	{ PRIVILEGE_LEVEL_ADMIN, "pullDatabaseErrors", NULL, pullDatabaseErrors, replyFree },
	{ PRIVILEGE_LEVEL_ADMIN, "pullDatabaseWarnings", NULL, pullDatabaseWarnings, replyFree },
	{ PRIVILEGE_LEVEL_ADMIN, "pullDatabaseTablestatus", NULL, pullDatabaseTablestatus, replyFree },
	{ PRIVILEGE_LEVEL_ADMIN, "listSession", NULL, listSession, replyFree },

	{ PRIVILEGE_LEVEL_ADMIN, "listUser", NULL, listUser, replyFree },
	{ PRIVILEGE_LEVEL_READ, "pullUser", NULL, pullUser, replyFree },
	{ PRIVILEGE_LEVEL_ADMIN, "searchUser", NULL, searchUser, replyFree },
	{ PRIVILEGE_LEVEL_ADMIN, "newUser", NULL, newUser, replyFree },
	{ PRIVILEGE_LEVEL_WRITE, "pushUser", NULL, pushUser, replyFree },
	{ PRIVILEGE_LEVEL_ADMIN, "deleteUser", NULL, deleteUser, replyFree },

	{ PRIVILEGE_LEVEL_ADMIN, "listGroup", NULL, listGroup, replyFree },
	{ PRIVILEGE_LEVEL_ADMIN, "pullGroup", NULL, pullGroup, replyFree },
	{ PRIVILEGE_LEVEL_ADMIN, "searchGroup", NULL, searchGroup, replyFree },
	{ PRIVILEGE_LEVEL_ADMIN, "newGroup", NULL, newGroup, replyFree },
	{ PRIVILEGE_LEVEL_ADMIN, "pushGroup", NULL, pushGroup, replyFree },
	{ PRIVILEGE_LEVEL_ADMIN, "deleteGroup", NULL, deleteGroup, replyFree },
