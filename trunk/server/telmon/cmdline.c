...
void cmdProcServer(char *thisOption) {
	configUpdateString("telmond_server", thisOption);
}

void cmdProcPort(char *thisOption) {
	configUpdateInteger("telmond_port", thisOption);
}

void cmdProcFreq(char *thisOption) {
	configUpdateInteger("update_frequency", thisOption);
}

void cmdProcPassword(char *thisOption) {
	configUpdateString("server_password", thisOption);
}
