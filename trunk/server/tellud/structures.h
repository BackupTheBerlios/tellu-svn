...
struct threadStorageInfo {
	int i, s;								// Thread local variables
...
struct threadDbInfo {
	...
	unsigned long long (*pullid)(struct threadStorageInfo *, char *);	// Id number reading routine
};

struct threadInfo {
	size_t s, t;								// Thread local variables
	int *a;									// Thread local variables
	int i, j, k, l, n, o, r;						// Thread local variables
	...
	unsigned char *c, *d;							// Thread database id variables
	unsigned long long v, w;						// Thread database id variables
	unsigned long long id;							// Thread database id
	unsigned long long th;							// Thread database id being served
	char *dataPacket;							// Thread data packet pointer
	char *dataDeflate;							// Thread data packet pointer for decompression
	char *dataPointer, *dataBuffer, *escpBuffer, *statBuffer;		// Thread data pointers
